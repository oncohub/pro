      ...
      function ($timeout, $ionicGesture, $ionicPlatform) {
                ...
                if ($ionicPlatform.is('android')) {
                    filterBarTemplate =
                        ...
                        '<button class="filter-bar-clear button button-icon icon" ng-class="getClearButtonClass()" id="clearBtn"></button>' +
                        '</label>' +
                        '</div>' +
                        '</div>';
                } else {
                ...
                return {
                    ...
                    link: function ($scope, $element) {
                        ...
                        filterWatch = $scope.$watch('data.filterText', function (newFilterText, oldFilterText) {
                            console.log('$destroy', newFilterText, oldFilterText);
                            var delay;
      ...
      function ($document, $rootScope, $compile, $timeout, $filter, $ionicPlatform, $ionicFilterBarConfig, $ionicConfig, $ionicModal, $ionicScrollDelegate) {
                ...
                function filterBar(opts) {
                    ...
                    angular.extend(scope, {
                        ...
                        delay: 300,
                        cancelText: 'Cancel',
                        cancelOnStateChange: false, // kwata true
                        container: $body,
                    ...
                    var element = scope.element = $compile('<ion-filter-bar id="filterBar" class="filter-bar"></ion-filter-bar>')(scope);
